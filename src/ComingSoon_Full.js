        ...
        return (
            <div>
                ...
                <section className="header-video">
                    ...
                    <img src={video_fix} alt="" className="header-video--media"
                         data-video-src={`${process.env.PUBLIC_URL}/video/intro`}
                         data-teaser-source={`${process.env.PUBLIC_URL}/video/intro`} data-provider="vimeo"/>
                </section>
                <div className="container margin_60_35">
                    <Row style={{textAlign: "center"}}>
                        <Col md={4} style={{textAlign: "justify"}}>
                            ...
                            <p style={{textAlign: "center"}}><strong>A one-stop solution. Your personal waiter!</strong>
                            </p>
                            <p>
                                Kumba's character combines the access of an online eatery system with the comfort of
                                facebook Messenger.
                            </p>
                            <p>
                                Group Ordering cannot be more easier either. Kumba allows you to share the order with
                                your facebook friends so they can order for themselves.
                            </p><p>Kumba's scheduling intelligence will make sure you do not have wait at the eatery for
                            table, or for the waiter to come to your table or even for your food while at the table.
                            Kumba also provides a unique, flexible and secure payment system to help you and your
                            friends pay for anyone in the order.
                        </p>
                            {/* <p>
                            ...
                            <p>
                                ...
                                All you need to do is Like Kumba on facebook and start messaging him to get him at your
                                service.
                            ...
                            <h2><a href="https://www.facebook.com/meetkumba"><img alt="" width="240"
                                                                                  src={facebook}/></a></h2>
                        ...
                        <div className="row">
                            <div className="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                                <div className="feature">
                                    ...
                                    <p style={{textAlign: "justify"}}>
                                        By just messaging Kumba, he will become a chat window on your Messenger app.
                                        Nothing new to install and you can continue chatting with your friends while
                                        ordering.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="col-md-6 wow fadeIn" data-wow-delay="0.2s">
                                <div className="feature">
                                    ...
                                    <p style={{textAlign: "justify"}}>
                                        If you are ordering with a group, Kumba will share the order with your friends
                                        so that they can add their own items through their own Messenger. Kumba will
                                        manage everything.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 wow fadeIn" data-wow-delay="0.4s">
                                <div className="feature">
                                    ...
                                    <p style={{textAlign: "justify"}}>
                                        During busy days, Kumba will make sure you do not have to wait idly at the
                                        location. Kumba's intelligent waitlist management
                            ...
                            <div className="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                                <div className="feature">
                                    ...
                                    <p style={{textAlign: "justify"}}>
                                        Once at your table, Kumba becomes your instant personal waiter. Browse the menu
                                        and tell Kumba what you like. It will be communicated to the chef just like any
                                        waiter.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 wow fadeIn" data-wow-delay="0.4s">
                                <div className="feature">
                                    ...
                                    <p style={{textAlign: "justify"}}>
                                        Kumba can already be your personal waiter before reaching the table. You can
                                        select the items
                            ...
                            <div className="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                                <div className="feature">
                                    ...
                                    <p style={{textAlign: "justify"}}>
                                        If dining with a group, Kumba will split cheques and manage payments so that you
                                        dont need to split hairs.
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 nopadding">
                                <div className="features-content">
                                    ...
                                    <br />
                                    <p style={{textAlign: "justify"}}>
                                        Food Bots Inc. aims to create chatbots that help get the food, customers want
                                        and need, without compromising the taste
                                    </p>
                                    <p style={{textAlign: "justify"}}>
                                        Kumba is the first chatbot, a waiter assistant, that comes out of FoodBots'
                                        factory. He will serve you as a personal assistant to order food from your
                                        facebook Messenger.
                                    </p>
                                </div>
                            </div>
